...
const CATEGORY_ICONS = {
  ...
  Lazo: (
    <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
      ...
      <path d="M8 24c0 6 4 10 9 10s8-4 7-8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none"/>
      <path d="M40 24c0-6-4-10-9-10s-8 4-7 8 4 8 7 8 6-3 6-6-3-6-6-6-7 3-7 6 2 6 6 8 9 4 9 2"
        stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none"/>
      <path d="M40 24c0 6-4 10-9 10s-8-4-7-8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none"/>
    </svg>
  ),
  Arras: (
    <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
      <ellipse cx="24" cy="14" rx="12" ry="5" stroke="currentColor" strokeWidth="2"/>
      <path d="M12 14v5c0 2.76 5.37 5 12 5s12-2.24 12-5v-5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
      <path d="M12 19v5c0 2.76 5.37 5 12 5s12-2.24 12-5v-5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
      <path d="M12 24v5c0 2.76 5.37 5 12 5s12-2.24 12-5v-5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    </svg>
  ),
  Ramo: (
    <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
      ...
      <path d="M17 26c2-2 4-3 7-3s5 1 7 3l2 14H15l2-14z"
        stroke="currentColor" strokeWidth="2" strokeLinejoin="round" fill="none"/>
      <line x1="24" y1="23" x2="24" y2="28" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    </svg>
  ),
  Anillos: (
    <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
...
const DEFAULT_ICON = (
  <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
    <path d="M6 28l8-8 6 3 8-8 8 3 6-4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M4 30s3 7 10 7 10-5 10-5l10 3c3 0 6-3 6-6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none"/>
  </svg>
);
...
export default function InvSponsors() {
  ...
  const photoSrc  = WEDDING.sectionPhotos.sponsors;
  ...
  return (
    <section className="inv-section inv-section--split inv-split--photo-right inv-sponsors">

      {/* Mitad izquierda: contenido (carousel de padrinos) */}
      <div className="inv-split__content">

        <InvReveal delay={0}>
          <p className="inv-section__label">Con el apoyo de</p>
        </InvReveal>
        ...
        <InvReveal delay={0.22}>
          <div className="inv-sponsors__carousel" role="region" aria-label="Padrinos">
            <button className="inv-sponsors__arrow" onClick={prev} aria-label="Padrino anterior">
              &#8249;
            </button>
            ...
            <button className="inv-sponsors__arrow" onClick={next} aria-label="Siguiente padrino">
              &#8250;
            </button>
          </div>
        </InvReveal>
      ...
      <div className="inv-split__photo">
        {photoSrc && <img src={photoSrc} alt="Padrinos" />}
      </div>
