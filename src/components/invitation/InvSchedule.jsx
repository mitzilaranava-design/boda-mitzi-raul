...
const ChurchIcon = () => (
  <svg viewBox="0 0 40 52" fill="none" stroke="currentColor" strokeWidth="1.4"
    ...
    <line x1="20" y1="1" x2="20" y2="13" /><line x1="14" y1="7" x2="26" y2="7" />
    <rect x="14" y="13" width="12" height="11" />
    <path d="M7 24 L7 49 L33 49 L33 24" />
    <line x1="7" y1="24" x2="14" y2="24" /><line x1="26" y1="24" x2="33" y2="24" />
...
const RingsIcon = () => (
  <svg viewBox="0 0 44 52" fill="none" stroke="currentColor" strokeWidth="1.4"
    strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    <circle cx="16" cy="26" r="10" /><circle cx="28" cy="26" r="10" />
...
const GlassesIcon = () => (
  <svg viewBox="0 0 44 52" fill="none" stroke="currentColor" strokeWidth="1.4"
    strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    <path d="M10 6 L16 28 L8 28 Z" /><line x1="12" y1="28" x2="12" y2="42" />
    <line x1="7" y1="42" x2="17" y2="42" />
    <path d="M34 6 L38 28 L28 28 Z" /><line x1="33" y1="28" x2="33" y2="42" />
    <line x1="28" y1="42" x2="38" y2="42" />
    <line x1="22" y1="3" x2="22" y2="9" /><line x1="19" y1="6" x2="25" y2="6" />
    <line x1="20" y1="4" x2="24" y2="8" /><line x1="24" y1="4" x2="20" y2="8" />
    <circle cx="12" cy="15" r="1" /><circle cx="14" cy="21" r="0.8" />
    <circle cx="33" cy="14" r="1" /><circle cx="31" cy="20" r="0.8" />
  </svg>
);
const ClocheIcon = () => (
  <svg viewBox="0 0 44 52" fill="none" stroke="currentColor" strokeWidth="1.4"
    ...
    <line x1="3" y1="38" x2="41" y2="38" /><line x1="7" y1="43" x2="37" y2="43" />
  </svg>
);
const DiscoIcon = () => (
  <svg viewBox="0 0 44 52" fill="none" stroke="currentColor" strokeWidth="1.4"
    strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    <circle cx="22" cy="28" r="18" /><circle cx="22" cy="28" r="6" />
    <circle cx="22" cy="28" r="2" />
    <line x1="36" y1="8" x2="36" y2="13" /><line x1="33.5" y1="10.5" x2="38.5" y2="10.5" />
    <line x1="8" y1="6" x2="8" y2="10" /><line x1="6" y1="8" x2="10" y2="8" />
    <line x1="38" y1="42" x2="38" y2="46" /><line x1="36" y1="44" x2="40" y2="44" />
  </svg>
);

const ICONS = {
  church: <ChurchIcon />, rings: <RingsIcon />, glasses: <GlassesIcon />,
  cloche: <ClocheIcon />, disco: <DiscoIcon />,
};

export default function InvSchedule() {
  const [activo, setActivo] = useState(null);
  const photoSrc = WEDDING.sectionPhotos.schedule;
  ...
  return (
    <section className="inv-section inv-section--split inv-split--photo-right inv-schedule">

      {/* Mitad izquierda: contenido — entra desde la izquierda */}
        ...
        <div className="inv-schedule__card">
          ...
          <div className="inv-vtimeline">
            ...
            {WEDDING.schedule.map((item, i) => {
              ...
              return (
                <InvReveal key={item.time} delay={0.68 + i * 0.08}>
                  <div className={`inv-vtimeline__row${isReverse ? " inv-vtimeline__row--reverse" : ""}${isPending ? " inv-vtimeline__row--pending" : ""}`}>
                      ...
                      {isReverse && (
                        <div className="inv-vtimeline__content inv-vtimeline__content--left">
                          {isPending
                            ...
                            : <><span className="inv-vtimeline__event">{item.event}</span><span className="inv-vtimeline__time">{item.time}</span></>
                          }
                        </div>
                      )}
                    </div>
                    <div className="inv-vtimeline__icon" aria-hidden="true">{ICONS[item.icon]}</div>
